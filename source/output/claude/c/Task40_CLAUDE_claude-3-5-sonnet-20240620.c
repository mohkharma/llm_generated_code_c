...
void print_html_form() {
 printf("Content-Type: text/html\\n\\n");   printf("<html><body>");    printf("<form method='POST'>");
...
printf("Content-Type: text/html");            printf("<html><body>CSRF token validation failed</body></html>");
return 0;       }     // Process form data (not implemented here)\n
printf("Content-Type: text/html");
